...
2. Run the generate_tiles.py script in . This is a modified version of the script from the <a href="https://github.com/openstreetmap/mapnik-stylesheets/blob/master/generate_tiles.py">openstreetmap project.</a></br>
3.Docker
<p>
